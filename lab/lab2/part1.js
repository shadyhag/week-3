...
For data, use the following two lists of board game collections. just use arrays functions from underscore

//_.each(rest, function(value){consol.log(_.value(value));})
===================== */
